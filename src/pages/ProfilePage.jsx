    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <header className="sticky top-0 z-20 border-b bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-3 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" aria-label="Home" onClick={onGoHome}>
      ...
      <main className="mx-auto max-w-4xl px-4 py-6 space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="leading-tight">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      ...
                      <Badge variant="outline">Sofa</Badge>
                    </div>
                  </div>
                </div>
              ...
              <>
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <Button
                    type="button"
                    onClick={saveBio}
                    disabled={saving || bioDraft === (profile?.bio ?? "")}
                  >
                    {saving ? "Saving..." : "Save"}
                  </Button>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="text-sm text-muted-foreground">
              Placeholder. Next we’ll load your posts from Supabase and render them here.
            </div>
